...
console.log(permuteRows(addFullName, [{first: "joseph", last: "schmitt"}]));
...
console.log(createObjects(PersonWithFullName, [{first: "banjo", last: "schmitt"}]).map(obj => obj.fullName)
);